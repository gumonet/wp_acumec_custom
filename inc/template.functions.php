...
function acumec_page_title(){
    ...
    if(isset($opt_theme_options['page_title_align']))
      ...
      if( is_product() || is_shop() || is_product_category() ){
        $bg_color ='background-color: rgba(0, 88, 234, 0.96);';
        $image1 = "background-image:none";
      } else {
        global $post;
        ...
        if ( !empty( $thumbID ) ) {
          $imgDestacada = wp_get_attachment_image_src( $thumbID, 'full' );
            ...
            $image1 = "background-image: url(".esc_attr($imgDestacada[0])."); background-position: center; background-size: cover; background-attachment: fixed;";
        } else {
    ...
    /*if(!is_page() && !empty($opt_theme_options['single_page_title_layout']) && $opt_theme_options['single_page_title_layout'] > 1){
        ...
        if (!empty($opt_theme_options['single_page_title_background_image']) ){
            $image1 = "background-image: url(".esc_attr($opt_theme_options['page_title_background_image']['background-image']).");background-repeat:".$opt_theme_options['single_page_title_background_image']['background-repeat'].";background-size:".$opt_theme_options['single_page_title_background_image']['background-size'].";background-attachment:".$opt_theme_options['single_page_title_background_image']['background-attachment'].";background-position:".$opt_theme_options['single_page_title_background_image']['background-position']."; ";
        }
    }*/

    ?>
    <div id="page-title" data-rel="titulo-modificado" class="page-title <?php echo 'layout-'.esc_attr($layout);?>" style="<?php echo esc_attr($image1); ?>">
